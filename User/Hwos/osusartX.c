...
//static  void  _hwuart2_1msTask(void);
//static  void  _hwuart3_1msTask(void);
//static  void  _hwuart4_1msTask(void);
//static  void  _hwuart5_1msTask(void);
//static  void  _hwuart6_1msTask(void);
//static  void  _hwuart7_1msTask(void);
//static  void  _hwuart8_1msTask(void);
static  void  _hwuartX_ScanRxProcess(void);
//static  void  _hwuart1_ScanRxProcess(void);
//static  void  _hwuart2_ScanRxProcess(void);
//static  void  _hwuart3_ScanRxProcess(void);
//static  void  _hwuart4_ScanRxProcess(void);
//static  void  _hwuart5_ScanRxProcess(void);
//static  void  _hwuart6_ScanRxProcess(void);
//static  void  _hwuart7_ScanRxProcess(void);
//static  void  _hwuart8_ScanRxProcess(void);
...
//	t_systmr_insertQuickTask(_hwuart3_ScanRxProcess, 10, OSTMR_PERIODIC);
//	t_systmr_insertQuickTask(_hwuart4_ScanRxProcess, 10, OSTMR_PERIODIC);
//	t_systmr_insertQuickTask(_hwuart5_ScanRxProcess, 10, OSTMR_PERIODIC);
//	t_systmr_insertQuickTask(_hwuart6_ScanRxProcess, 10, OSTMR_PERIODIC);
//	t_systmr_insertQuickTask(_hwuart7_ScanRxProcess, 10, OSTMR_PERIODIC);
